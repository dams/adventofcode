defmodule Exercise1 do
	...
	def parse(grid, "turn off " <> line) do parse(grid, line, &( { &1, case &1 do nil -> 0; 0 -> 0; _ -> &1-1 end } ))  end
	def parse(grid, "toggle "   <> line) do parse(grid, line, &( { &1, case &1 do nil -> 2; _ -> &1+2 end } )) end
